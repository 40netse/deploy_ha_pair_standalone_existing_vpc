#
# This template will require heavy modification before use. It is a template for doing many things
# that a deployment into an existing VPC may not require. Use with care.
#
provider "aws" {
